...
//Also added some additional generic classes with the 'thumb' style for page individualization
					$('#thumbs'+randID).append('<div class="thumb s1 s2" id="thumb'+randID+'_'+(i+1)+'" style="cursor:pointer;background-image:url('+thumb+');display:inline;float:left;width:'+o.thumbnailWidth+';height:'+o.thumbnailHeight+';line-height:'+o.thumbnailHeight+';padding:0;overflow:hidden;text-align:center;border:2px solid #ccc;font-size:'+o.thumbnailFontSize+';color:#000;text-shadow:0 0 3px #fff">'+(i+1)+'</div>');
